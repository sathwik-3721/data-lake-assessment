...
// const getAllLoadTypes = (data) => [...new Set(data.flatMap((d) => d.loadType))];
...
//         console.log("useEffect - Parsed ETL Data:", parsed);
//         setEtlData(parsed?.data || []);
//         setScoreValues(parsed?.scoreValues || {}); // ✅ Add this
//       } catch (err) {
//         console.error("Invalid JSON in etlData:", err);
//       }
//     }
//   }, []);
...
//         ? entry.loadTypeDetails.filter((d) => d.loadType === selectedLoadType)
...
//   //       // acc.totalTables += detail.sumTotalTables?.[0] || 0;
//   //       acc.totalTables +=
//   //         detail.totalDestinationTables?.reduce((a, b) => a + b, 0) || 0;
...
//           detail.totalDestinationTables?.reduce((a, b) => a + b, 0) || 0;
//         acc.totalPipelines += detail.ETLPipeline?.length || 0;
//         acc.totalMinutes += detail.totalPipelineDurationMin || 0;
//       });
//       return acc;
//     },
...
//               totalMinutes={scoreValues.totalPipelineDurationMin}
//             />
//           </div>
//         </div>
//       </div>

//       <LineageFlow lineageData={etlDataFromState || etlData} />
//     </main>
//   );
// }
...
export default function LineageFlowView() {
  ...
  return (
    <main className="min-h-screen bg-white text-black font-sans">
      ...
      {/* ✅ Pass filtered data to LineageFlow */}
